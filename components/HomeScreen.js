...
const styles = StyleSheet.create({
  ...
  bikeImage: { width: 200, height: 200, marginBottom: 20, backgroundColor : "#E941411A", borderRadius : 50, padding : 20 },
  title: { fontSize: 24, fontWeight: 'bold', marginBottom: 10, textAlign: 'center' },
  subtitle: { fontSize: 16, color: 'black', fontWeight : "bold", textAlign: 'center', marginBottom: 20 },
  button: { backgroundColor: '#FF6F61', paddingVertical: 10, paddingHorizontal: 20, borderRadius: 5, marginTop: 20 },
